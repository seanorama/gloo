...
func (m *ListenerReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	case *ListenerReport_MatchedHttpListenerReport:
		...
		if h, ok := interface{}(m.GetMatchedHttpListenerReport()).(safe_hasher.SafeHasher); ok {
			if _, err = hasher.Write([]byte("MatchedHttpListenerReport")); err != nil {
				return 0, err
			}
			if _, err = h.Hash(hasher); err != nil {
				return 0, err
			...
			if fieldValue, err := hashstructure.Hash(m.GetMatchedHttpListenerReport(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("MatchedHttpListenerReport")); err != nil {
					return 0, err
...
// Hash function
func (m *MatchedHttpListenerReport) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/gloo/projects/gloo/pkg/api/grpc/validation.MatchedHttpListenerReport")); err != nil {
		return 0, err
	}
