...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_rawDesc = []byte{
	...
	0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0x9e, 0x01, 0x0a, 0x2c, 0x69, 0x6f, 0x2e, 0x65, 0x6e, 0x76,
	...
	0x61, 0x74, 0x61, 0x2f, 0x76, 0x33, 0xe2, 0xb5, 0xdf, 0xcb, 0x07, 0x02, 0x10, 0x02, 0xb8, 0xf5,
...
var file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_goTypes = []interface{}{
...
func file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*MetadataKind_Request_)(nil),
		(*MetadataKind_Route_)(nil),
		(*MetadataKind_Cluster_)(nil),
		(*MetadataKind_Host_)(nil),
	}
	file_github_com_solo_io_gloo_projects_gloo_api_external_envoy_type_metadata_v3_metadata_proto_msgTypes[2].OneofWrappers = []interface{}{
