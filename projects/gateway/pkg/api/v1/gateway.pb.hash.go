...
func (m *Gateway) Hash(hasher hash.Hash64) (uint64, error) {
	...
	case *Gateway_MatchedHttpGateways:

		if h, ok := interface{}(m.GetMatchedHttpGateways()).(safe_hasher.SafeHasher); ok {
			if _, err = hasher.Write([]byte("MatchedHttpGateways")); err != nil {
				return 0, err
			}
			if _, err = h.Hash(hasher); err != nil {
				return 0, err
			...
			if fieldValue, err := hashstructure.Hash(m.GetMatchedHttpGateways(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("MatchedHttpGateways")); err != nil {
					return 0, err
...
// Hash function
func (m *MatchedHttpGateway) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/gloo/projects/gateway/pkg/api/v1.MatchedHttpGateway")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *MatchedHttpGateways) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/gloo/projects/gateway/pkg/api/v1.MatchedHttpGateways")); err != nil {
		return 0, err
	}
